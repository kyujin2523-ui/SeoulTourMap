...
export default function NaverMap({ places }: Props) {
  ...
  // Init map after SDK loads (or immediately if SDK already loaded)
  function initMap() {
    ...
    placeList.forEach((place) => {
      ...
      const infoContent = `
        <div style="padding:12px;max-width:240px;font-family:'Segoe UI',sans-serif;">
          ...
          <p style="margin:0;font-size:12px;color:#666;background:#f5f5f5;padding:6px 8px;border-radius:4px;">
