...
const styles: Record<string, React.CSSProperties> = {
  ...
  name: { margin: 0, fontSize: "16px", fontWeight: 700, color: "#1a1a1a" },
  address: { margin: 0, fontSize: "13px", color: "#888" },
  description: { margin: 0, fontSize: "14px", color: "#444", lineHeight: 1.5 },
  tipsBox: {
    fontSize: "13px",
    color: "#555",
    background: "#f5f5f5",
